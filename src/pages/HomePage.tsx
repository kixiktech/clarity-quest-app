    ...
    <BackgroundImage>
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-6 -mt-20">
        <button
          ...
          className="w-64 py-3 rounded-xl bg-gradient-to-r from-primary/90 to-purple-500 text-white font-medium text-lg uppercase
            shadow-[0_0_20px_rgba(155,135,245,0.3)] relative overflow-hidden
            ...
            hover:shadow-[0_0_30px_rgba(155,135,245,0.5)] hover:scale-[1.02]"
        >
