...
const PersonalGrowthPage: FC = () => {
  ...
  const handleSubmit = (text: string) => {
    toast({
      ...
      description: "Your personal growth goals have been recorded. Let's move on to the next category.",
    });
    navigate("/confidence");
  };
    ...
    <div className="min-h-screen w-full bg-background flex flex-col items-center justify-center p-6">
      <div className="max-w-4xl w-full space-y-8">
        ...
        <div className="text-center space-y-6">
          <h1 className="text-4xl font-bold text-primary">Personal Growth & Mindset</h1>
